...
public:
	...
	void SetSourceUVBounds(FRHICommandList& RHICmdList, const FVector4& InSourceUVBounds)
	{
	 ...
	 */
	void SetMaskTransform(FRHICommandList& RHICmdList, FVector2D InMaskTransform)
	{
