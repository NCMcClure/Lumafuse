...
#include "SDragScrollBox.h"
#include "DragScrollBox.generated.h"

UCLASS()
class VRDEBUGPLUGIN_API UDragScrollBoxSlot : public UPanelSlot
{
...
public:
	...
	void BuildSlot(TSharedRef<SDragScrollBox> ScrollBox);
...
private:
	...
	SDragScrollBox::FSlot* Slot;
};

UCLASS()
class VRDEBUGPLUGIN_API UDragScrollBox : public UPanelWidget
{
	GENERATED_UCLASS_BODY()
...
protected:
	...
	TSharedPtr<class SDragScrollBox> MyScrollBox;
