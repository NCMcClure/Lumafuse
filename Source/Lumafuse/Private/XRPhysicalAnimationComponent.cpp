...
UXRPhysicalAnimationComponent::UXRPhysicalAnimationComponent(const FObjectInitializer& ObjectInitializer)
...
void UXRPhysicalAnimationComponent::SetWeldedBoneDriverPaused(bool bPaused)
{
	bIsPaused = bPaused;
}

bool UXRPhysicalAnimationComponent::IsWeldedBoneDriverPaused()
{
	return bIsPaused;
}

void UXRPhysicalAnimationComponent::RefreshWeldedBoneDriver()
{
	SetupWeldedBoneDriver_Implementation(true);
}

void UXRPhysicalAnimationComponent::SetupWeldedBoneDriver(TArray<FName> BaseBoneNames)
{
...
FTransform UXRPhysicalAnimationComponent::GetWorldSpaceRefBoneTransform(FReferenceSkeleton& RefSkel, int32 BoneIndex, int32 ParentBoneIndex)
{
...
FTransform UXRPhysicalAnimationComponent::GetRefPoseBoneRelativeTransform(USkeletalMeshComponent* SkeleMesh, FName BoneName, FName ParentBoneName)
{
	FTransform BoneTransform;
...
void UXRPhysicalAnimationComponent::SetupWeldedBoneDriver_Implementation(bool bReInit)
{
...
void UXRPhysicalAnimationComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction *ThisTickFunction)
{
...
void UXRPhysicalAnimationComponent::UpdateWeldedBoneDriver(float DeltaTime)
{
