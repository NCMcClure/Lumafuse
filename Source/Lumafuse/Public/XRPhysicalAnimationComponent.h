...
#include "XRPhysicalAnimationComponent.generated.h"

/**
 * 
 */
USTRUCT()
struct LUMAFUSE_API FWeldedBoneDriverData
{
	GENERATED_BODY()
public:
...
class LUMAFUSE_API UXRPhysicalAnimationComponent : public UPhysicalAnimationComponent
{
