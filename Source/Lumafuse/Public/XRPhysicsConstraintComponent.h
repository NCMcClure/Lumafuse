...
#include "XRPhysicsConstraintComponent.generated.h"

/**
 * 
 */
UCLASS(ClassGroup = Physics, meta = (BlueprintSpawnableComponent), HideCategories = (Activation, "Components|Activation", Physics, Mobility), ShowCategories = ("Physics|Components|PhysicsConstraint", "XR Constraint Settings"))
class LUMAFUSE_API UXRPhysicsConstraintComponent : public UPhysicsConstraintComponent
{
	GENERATED_BODY()
public:

	UFUNCTION(BlueprintCallable, Category = "XR Physics Constraint Component")
	...
	UFUNCTION(BlueprintPure, Category = "XR Physics Constraint Component")
